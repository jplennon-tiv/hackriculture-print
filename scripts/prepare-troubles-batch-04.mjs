...
import plans from '../docs/troubles-design/batch-04-copy.mjs';
import sourceEdits from '../docs/troubles-design/batch-04-source-edits.mjs';
...
const images=JSON.parse(fs.readFileSync('docs/troubles-design/batch-04-results.json','utf8'));assert.equal(images.length,11);
...
console.log('Source/art',saveCollections({troubles:data},{actor:'User-authorised organic source correction and artwork batch 04 (model not recorded)',expectedRevision:rev}));
