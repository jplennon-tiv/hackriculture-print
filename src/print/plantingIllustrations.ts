...
export const pendingPlantingLayouts: Record<string, PlantingLayout> = {
    ...
    tomato_greenhouse: {"stages":[{"id":"step1","image":"/images/planting/tomato_greenhouse/grow-on-in-pot-v1.png"},{"id":"step2","image":"/images/planting/tomato_greenhouse/plant-and-support-v1.png"}],"paired":true,"imageMm":14,"minImageMm":14,"maxImageMm":14,"measurements":[]},
...
export const plantingLayouts: Record<string, PlantingLayout> = {
    ...
    cucumber_outdoor: {...bounds,paired:true,imageMm:14,maxImageMm:14,stages:[
        ...
        {label:'Rows / growing system',path:source('row_spacing')},
        {label:'Final plants',path:source('plant_spacing')},
    ]},
